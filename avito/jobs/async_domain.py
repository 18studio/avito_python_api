"""Async-доменные объекты пакета jobs."""
...
class AsyncVacancy(AsyncDomainObject):
    ...
    async def create(
        ...
        *,
        ...
        if version == 1:
            ...
            return await self.create_classic(
                title=title,
    ...
    async def update(
        ...
        *,
        ...
        if version == 1:
            return await self.update_classic(
...
@dataclass(slots=True, frozen=True)
class AsyncApplication(AsyncDomainObject):
    ...
    async def get_states(
        ...
        return await self._execute(GET_APPLICATION_STATES, timeout=timeout, retry=retry)
...
@dataclass(slots=True, frozen=True)
class AsyncResume(AsyncDomainObject):
...
@dataclass(slots=True, frozen=True)
class AsyncJobWebhook(AsyncDomainObject):
    ...
    async def get(
        ...
        return await self._execute(GET_JOB_WEBHOOK, timeout=timeout, retry=retry)
    ...
    async def list(
        ...
        return await self._execute(LIST_JOB_WEBHOOKS, timeout=timeout, retry=retry)
...
@dataclass(slots=True, frozen=True)
class AsyncJobDictionary(AsyncDomainObject):
    ...
    async def list(
        ...
        return await self._execute(LIST_JOB_DICTIONARIES, timeout=timeout, retry=retry)
