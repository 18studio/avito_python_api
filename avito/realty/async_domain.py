"""Async-доменные объекты пакета realty."""
...
class AsyncRealtyListing(AsyncDomainObject):
    """Async-доменный объект объявления краткосрочной аренды."""
    ...
    async def get_intervals(
        ...
        *,
        ...
        """Возвращает intervals для посутчной аренды асинхронно.
    ...
    async def update_base_params(
        ...
        *,
        ...
        """Обновляет base params для посутчной аренды асинхронно.
...
@dataclass(slots=True, frozen=True)
class AsyncRealtyBooking(AsyncDomainObject):
    """Async-доменный объект бронирований недвижимости."""
    ...
    async def update_bookings_info(
        self,
        *,
        ...
        """Обновляет информацию о бронированиях недвижимости асинхронно.
    ...
    async def list_realty_bookings(
        self,
        *,
        ...
        """Возвращает список realty bookings для бронирований недвижимости асинхронно.
...
@dataclass(slots=True, frozen=True)
class AsyncRealtyPricing(AsyncDomainObject):
    """Async-доменный объект цен краткосрочной аренды."""
    ...
    async def update_realty_prices(
        self,
        *,
        ...
        """Обновляет realty prices для цен недвижимости асинхронно.
...
@dataclass(slots=True, frozen=True)
class AsyncRealtyAnalyticsReport(AsyncDomainObject):
    """Async-доменный объект аналитики по недвижимости."""
    ...
    async def get_market_price_correspondence(
        ...
        *,
        ...
        """Возвращает соответствие цены объявления рынку недвижимости асинхронно.
    ...
    async def get_report_for_classified(
        self,
        *,
        item_id: int | str | None = None,
        idempotency_key: str | None = None,
        ...
        """Возвращает аналитический отчет по объявлению недвижимости асинхронно.
